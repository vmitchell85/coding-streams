                        ...
                        @if ($stream->service == 'youtube')
                            <a href="https://youtube.com/watch?v={{$stream->identifier}}" target="_blank" class="w-full md:w-1/2 lg:w-1/3 xl:w-1/4 hover:opacity-75 p-4">
                                <div class="relative w-full bg-cover bg-center border-4 border-youtube" style="background-image: url('{{$stream->image}}'); padding-top: 56.25%;">
                                    ...
                                    <div class="w-full h-full absolute inset-0 flex items-center justify-center">
                                        <svg class="h-16" viewBox="0 0 66 54" preserveAspectRatio="xMidYMid meet" focusable="false" class="style-scope ytd-topbar-logo-renderer" style="pointer-events: none; display: block;"><g viewBox="0 0 200 60" preserveAspectRatio="xMidYMid meet" class="style-scope ytd-topbar-logo-renderer">
