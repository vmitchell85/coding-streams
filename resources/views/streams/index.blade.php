            ...
            <div class="flex flex-col mt-5">
                ...
                <div class="flex flex-wrap mt-5">
                    @foreach($streams as $stream)
                        <a href="https://twitch.tv/{{$stream->user_name}}" target="_blank" class="w-1/4 hover:opacity-75 p-4 @if ($loop->first || ($loop->iteration % 4 == 1)) pl-0 @endif @if ($loop->last || ($loop->iteration % 4 == 0)) pr-0 @endif">
                            <div class="relative w-full h-48 bg-cover flex items-center justify-center border-4 border-twitch" style="background-image: url('{{$stream->image}}')">
